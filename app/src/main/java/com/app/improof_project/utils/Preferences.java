package com.app.improof_project.utils;
...
public class Preferences {
    ...
    public static void removeAllPreferenceExceptDeviceID(Context context) {
        SharedPreferences settings = Preferences.getSharedPreferences(context);
        SharedPreferences.Editor editor = settings.edit();
       // String deviceId = settings.getString(PreferenceEntities.DEVICE_ID, "");
        String USER_DETAILS = settings.getString(PreferenceEntities.USER_DETAILS,"");
        String USER_ID = settings.getString(PreferenceEntities.USER_ID,"");

        editor.clear();
        editor.commit();

        //editor.putString(PreferenceEntities.DEVICE_ID, deviceId);
        editor.commit();
    }
